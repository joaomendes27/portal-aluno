...
public class CreateTurmaCommandHandler : IRequestHandler<CreateTurmaCommand, TurmaResponse>
{
    ...
    public CreateTurmaCommandHandler(ITurmaRepository turmaRepository, IUnitOfWork unitOfWork, ISalaRepository salaRepository, ICursoRepository cursoRepository, IDisciplinaRepository disciplinaRepository, IProfessorRepository professorRepository)
    {
    ...
    public async Task<TurmaResponse> Handle(CreateTurmaCommand request, CancellationToken cancellationToken)
    {
        var turma = new Turma
        {
