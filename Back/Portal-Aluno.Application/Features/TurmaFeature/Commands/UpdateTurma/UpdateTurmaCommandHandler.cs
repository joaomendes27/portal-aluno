...
public class UpdateTurmaCommandHandler : IRequestHandler<UpdateTurmaCommand, TurmaResponse>
{
    ...
    public UpdateTurmaCommandHandler(ITurmaRepository turmaRepository, IUnitOfWork unitOfWork, ISalaRepository salaRepository, ICursoRepository cursoRepository, IDisciplinaRepository disciplinaRepository, IProfessorRepository professorRepository)
    {
    ...
    public async Task<TurmaResponse> Handle(UpdateTurmaCommand request, CancellationToken cancellationToken)
    {
